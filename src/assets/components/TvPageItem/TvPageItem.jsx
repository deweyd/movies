...
function TvPageItem({todosMovie, todosRole, todosVideo, handleElement}) {
        ...
        <div className={"movie movie-page"}>
            <div className='movie__item'>
                <div className="movie__left-box">
                    <Link href="" className='movie__img'>
                        {todosMovie.poster_path === null ? (
                            <img style={{width: '300px'}} src="https://i.ibb.co/2t0SLBN/noimage.png" alt="" />
                        ) : (
                ...
                <div className='movie__about'>
                    <div className="movie__title">{todosMovie.original_name}</div>
                    <div className="movie__number">
                        <div className="movie__year">Дата релізу<span>{todosMovie.last_air_date}</span></div>
                        <div className="movie__year">Кількість серій<span>{todosMovie.number_of_episodes}</span></div>
                    </div>
                    {todosMovie.overview ? (
